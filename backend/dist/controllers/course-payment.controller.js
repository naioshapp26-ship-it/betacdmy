...
import { createCourseCheckoutSession, confirmCoursePaymentSession, getCoursePaymentBySessionId, getStudentCoursePayments, resolveTenantRow } from '../services/course-payment.service.js';
...
export const createCoursePaymentRouter = () => {
     ...
     */
    router.post('/api/course-payment/checkout', async (req, res) => {
        try {
            const { tenantId, tenantSlug, courseId, studentId, studentEmail, courseName, coursePrice, currency } = req.body;
     ...
     */
    router.get('/api/course-payment/session/:sessionId', async (req, res) => {
        try {
     ...
     */
    router.post('/api/course-payment/confirm', async (req, res) => {
        try {
     ...
     */
    router.get('/api/course-payment/student/:studentId', async (req, res) => {
        try {
